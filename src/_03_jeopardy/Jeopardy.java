...
public class Jeopardy implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (buttonPressed.equals(firstButton)) {
			askQuestion("What movie with emoji's in it sucks?", "The Emoji Movie", 200);
			firstButton.setText("");
			firstButton= null;
		}
		...
		if (buttonPressed.equals(secondButton)) {
			askQuestion("What movie has Mike Myers and Eddie Murphy as the leading rolls?", "Shrek", 400);
